  ...
  return (
    <aside className="w-64 bg-primary-900 text-white flex flex-col min-h-screen shrink-0">
      ...
      <div className="px-3 pt-4 pb-2">
        <Link
          href="/app/jobs/new"
          className="flex items-center justify-center gap-2 w-full px-4 py-2.5 bg-accent-500 hover:bg-accent-600 text-white text-sm font-semibold rounded-lg transition-colors"
        >
